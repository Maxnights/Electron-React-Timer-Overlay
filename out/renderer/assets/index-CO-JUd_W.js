...
function TopBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-t-xl bg-blue-400 w-screen h-5", style: { WebkitAppRegion: "drag" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-blue-400 w-screen h-3" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "control-buttons", className: "text-stone-200 absolute top-1 right-0 pe-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "minimize", className: "p-1", onClick: handleMinimize, children: "🗕" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "close", className: "p-1", onClick: handleClose, children: "✕" })
    ] })
  ] });
}
function InputField({ label, value, onChange, placeHolder }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-3xl", children: [
...
const alarm = "" + new URL("alarm-sound-fB-8dlZ9.mp3", import.meta.url).href;
function Timer({ isOverlay }) {
  const [isEditing, setIsEditing] = reactExports.useState(false);
  const [minutes, setMinutes] = reactExports.useState(1);
      ...
      intervalId = setInterval(() => {
        if (seconds > 0) {
          ...
          if (minutes === 0 && hours === 0) {
            ...
            if (minutes === 0) {
              setHours((hours2) => hours2 - 1);
              setMinutes(59);
            } else {
              setMinutes((minutes2) => minutes2 - 1);
            }
            setSeconds(59);
          }
        }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: isEditing ? (
    //Time Setup
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        InputField,
        {
          label: "Hours",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-green-500 text-6xl", children: `${hours.toString().padStart(2, "0")}:${minutes.toString().padStart(2, "0")}:${seconds.toString().padStart(2, "0")}` }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          id: "timer-buttons",
...
function App() {
  const [isOverlay, setIsOverlay] = reactExports.useState(false);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: !isOverlay ? "visible" : "invisible", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TopBar, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: !isOverlay ? "bg-black bg-opacity-40 p-2 rounded-b-xl" : "bg-black bg-opacity-40 p-2 rounded-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Timer, { isOverlay }) })
  ] });
}
